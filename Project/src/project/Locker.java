...
public class Locker {
	public static void main(String[] args) {
		...
		System.out.println("---------------------------------------");
		System.out.println("Name        : B.kiran kumar");
		System.out.println("Email       : kirankumar@company.com");
		...
		lp : while(true)
		{
			...
			case 1: File file = new File("C:\\Users\\kiran\\OneDrive\\Desktop\\project");
					...
					ip : while(true)
					{
						...
						case 1 : System.out.println("\n---------------------------------------");
								 ...
								 try
								 {
									 ...
									 File fe = new File("C:\\Users\\kiran\\OneDrive\\Desktop\\project"+name);
									 if(fe.exists())
									 {
									 ...
									 {
										 FileWriter fw = new FileWriter("C:\\Users\\kiran\\OneDrive\\Desktop\\project"+name);
						...
						case 2 : System.out.println("\n---------------------------------------");
								 ...
								 File fd = new File("C:\\Users\\kiran\\OneDrive\\Desktop\\project"+deletename);
								 if(fd.exists())
								 {
									 if(fd.delete())
								        {
						...
						case 3 : System.out.println("\n---------------------------------------");
								 ...
								 try
								 {
									 File filesearch = new File("C:\\Users\\kiran\\OneDrive\\Desktop\\project");
